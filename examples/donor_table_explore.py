...
def get_donor(table, donor_num=1):
    ...
    donors = [
        donor for donor in donors if donor[0] != "" and donor[0] != "Unidentified"
    ]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--min_borrowed", type=int, default=0, help="Minimum borrowed quantity."
    )
    ...
    file_path = (
        Path(args.output)
        .joinpath("language_donors_mb" + str(min_borrowed) + ".csv")
        .as_posix()
    )
