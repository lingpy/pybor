...
def perform_prediction_by_language_from_table(language=None,
                                   detect_type=None,
                                   model_type=None,
                                   test_split=None,
                                   settings=None):
...
settings = cfg.RecurrentSettings(rnn_cell_type='GRU', embedding_len=16, rnn_output_len=32,
                                    learning_rate=0.01, learning_rate_decay=0.95,
                                    merge_embedding_dropout=0.2, rnn_output_dropout=0.2,
                                    recurrent_l2=0.001,
                                    batch_size=50, epochs=40,
                                    restore_best_weights=False)

perform_prediction_by_language_from_table(language='English',
                                   detect_type='dual',
